    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-6">
            <div className="bg-white border border-[#e4e8f0] rounded-2xl py-10 px-11 w-full max-w-[420px]">
                ...
                <h1 className="text-[1.4rem] font-bold text-[#1a1d2e] mb-1.5">Welcome back</h1>
                ...
                <p className="text-center mt-6 text-[0.825rem] text-gray-500">
                    ...
                    <Link to="/register" className="text-[#4f6ef7] no-underline font-medium hover:underline">Sign up</Link>
                </p>
            </div>
        </div>
    );
