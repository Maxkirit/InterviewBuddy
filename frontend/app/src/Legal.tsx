        ...
        <div className="max-w-2xl mx-auto px-6 py-10">
            ...
            <section id="terms">
                <h2 className="text-xl font-medium border-b pb-3 mb-6">Terms of Service</h2>
                    ...
                    <p className="text-gray-500 leading-relaxed mb-6">Interview Buddy is a student capstone project developed at École 42 Lausanne. It is a demonstration platform that allows recruiters and candidates to connect, schedule, and conduct system design interviews. It is not a commercial product.</p>
