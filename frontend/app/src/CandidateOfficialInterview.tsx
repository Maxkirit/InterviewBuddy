                ...
                <div key={interview.id} className="bg-white border border-[#e4e8f0] rounded-[14px] px-6 py-5 flex items-center gap-6">
                    <div className="flex items-center gap-3.5 flex-[0_0_240px]">
                        ...
                        <div className="flex flex-col gap-0.5">
                            <div className="text-[0.95rem] font-semibold text-[#1a1d2e]">Marcus Bell</div>
                            <div className="text-[0.8rem] text-gray-500">Vercel · {interview.jobTitle}</div>
                        </div>
                    </div>
            ...
            return (
                <div key={interview.id} className="bg-white border border-[#e4e8f0] rounded-[14px] px-6 py-5 flex items-center gap-6">
                    <div className="flex items-center gap-3.5 flex-[0_0_240px]">
                        ...
                        <div className="flex flex-col gap-0.5">
                            <div className="text-[0.95rem] font-semibold text-[#1a1d2e]">Jordan Lee</div>
                            <div className="text-[0.8rem] text-gray-500">Figma · {interview.jobTitle}</div>
                        </div>
                    </div>
                    <div className="flex-1 flex items-center gap-5 justify-end">
