            ...
            <div className="grid grid-cols-[220px_1fr] gap-10 items-start">
                ...
                <div className="flex flex-col items-center gap-5">
                    ...
                    <div className="text-center">
                        <div className="text-base font-bold text-[#1a1d2e]">{firstname} {lastname}</div>
                        <div className="text-[0.825rem] text-gray-500 mt-[3px]">{jobTitle}</div>
                        <div className="text-[0.825rem] text-gray-500 mt-[3px]">{country}</div>
                    </div>
                </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="form-field">
                                ...
                                <input className="form-input" type="date" id="dob" value={dob}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="form-field">
                                ...
                                <input className="form-input" type="tel" id="phone" placeholder="+1 555 000 0000"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="form-field">
                                ...
                                <input className="form-input" type="text" id="job_title" placeholder="e.g. Software Engineer"
                                    value={jobTitle} onChange={(e) => setJobTitle(e.target.value)} />
                            </div>
                            <div className="form-field">
                                <label htmlFor="org" className="form-label">Current organisation</label>
                                <input className="form-input" type="text" id="org" placeholder="e.g. Acme Corp"
                                    value={organisation} onChange={(e) => setOrganisation(e.target.value)} />
                            </div>
                        </div>
                        <div className="form-field">
                            <label htmlFor="bio" className="form-label">Bio</label>
                            <textarea id="bio" className="form-input resize-y min-h-[90px]"
                                placeholder="Tell recruiters a bit about yourself…"
                                value={bio} onChange={(e) => setBio(e.target.value)} />
                        </div>
                        <div className="form-field">
                            <label htmlFor="socials" className="form-label">LinkedIn</label>
                            <input className="form-input" type="url" id="socials"
                                placeholder="https://linkedin.com/in/yourname"
                                value={linkedin} onChange={(e) => setLinkedin(e.target.value)} />
                        </div>
                        <div className="flex justify-end mt-1">
                            <button className="btn-primary px-7 py-[10px]" type="submit">
                                Save
                            </button>
                        </div>
                    </form>
